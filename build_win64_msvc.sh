...
mkdir -p build_win64_msvc && cd build_win64_msvc
...
#     PB_BUILD=$(pwd)
#     cmake                                                               \
#         --toolchain $PB_BUILD/../../cmake_modules/msvc_toolchain.cmake  \
...
#     GNS_BUILD=$(pwd)
#     cmake                                                                                   \
#         --toolchain $GNS_BUILD/../../cmake_modules/msvc_toolchain.cmake                     \
#         -DCMAKE_BUILD_TYPE=Release                                                          \
...
#     PHYSFS_BUILD=$(pwd)
#     cmake                                                                   \
#         --toolchain $PHYSFS_BUILD/../../cmake_modules/msvc_toolchain.cmake  \
#         -DCMAKE_BUILD_TYPE=Release                                          \
...
#cmake .. --toolchain ../cmake_modules/msvc_toolchain.cmake -D USE_CRYPTO="BCrypt" -Dprotobuf_BUILD_TESTS=OFF
cmake                                                   \
    ..                                                  \
    --toolchain ../cmake_modules/msvc_toolchain.cmake   \
    &&                                                  \
