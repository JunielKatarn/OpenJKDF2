...
if [ ! -f build_gns/bin/libGameNetworkingSockets.dll ]; then
    ...
    GNS_BUILD=$(pwd)
    cmake --toolchain $GNS_BUILD/../../cmake_modules_windows/Windows.MSVC.toolchain.cmake                  \
        -DCMAKE_BUILD_TYPE=Release                                                          \
...
if [ ! -f build_physfs/libphysfs.a ]; then
    ...
    PHYSFS_BUILD=$(pwd)
    cmake   --toolchain $PHYSFS_BUILD/../../cmake_modules_windows/Windows.MSVC.toolchain.cmake \
        -DCMAKE_BUILD_TYPE=Release                                              \
